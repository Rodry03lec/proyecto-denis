...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item @if ($menu == '3'|| $menu == '2') open @endif">
        ...
        <li class="menu-item @if ($menu == '4'|| $menu == '5') open @endif">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ti ti-users"></i>
                <div data-i18n="Users">CONFIGURACION</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item @if ($menu == '4') active @endif">
                    <a href="{{ route('tip_index') }}" class="menu-link">
                        Tipologia
                    </a>
                </li>
            </ul>
